...
public final class GeneralConstants {
    ...
    public static final String WRONG_INPUT_FORMAT_ERROR_MESSAGE = "xlsColumns %s has wrong format. Supported input format: A,B,D or D-AA or mix of these two formats. Allowed values are in the range A-XSD";
